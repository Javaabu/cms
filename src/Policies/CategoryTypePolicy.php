...
class CategoryTypePolicy
{
    ...
    /**
     * Determine whether the user can view logs of the category type.
     */
    public function viewLogs(User $user, CategoryType $category_type): bool
    {
        return $this->update($user, $category_type);
    }
}
